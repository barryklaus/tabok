...
- When asked for offline and online updates, test and commit locally, then publish using the requested method and verify the live version. If publishing is blocked, clearly distinguish committed local work from the live site.
